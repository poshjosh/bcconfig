 ...
 */
public interface ConfigGroup<DATA_TYPE> extends Map<String, Config<DATA_TYPE>>{

    Config<DATA_TYPE> get(String filename);
     ...
     */
    Config<DATA_TYPE> subset(String filename, String subset_name, String separator);
    
    String getFor(String filename, String key);

    String getFor(String filename, String key, String defaultValue);

    Object setFor(String filename, String key, String value);
}
