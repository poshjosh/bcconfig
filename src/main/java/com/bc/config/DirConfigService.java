 ...
 */
public class DirConfigService extends PropertiesConfigService {
    ...
    public DirConfigService(ConfigGroup<Properties> configuration,
            String defaultPropertiesDir, String propertiesDir, 
            FilenameFilter filenameFilter,  String timePattern, boolean useCache) {
        this(
...
new Object[]{this.defaultPropertiesDir, this.propertiesDir});
    ...
    @Override
    public ConfigGroup<Properties> load() throws IOException {
    
        final ConfigGroup<Properties> output = this.isUseCache() ? this.getCachedConfigs() : new ConfigGroupImpl();
...
logger.log(Level.CONFIG, "Loading: {0}", name); 
    ...
    public void store() throws IOException {
        ...
        for(String fileName : fileNames) {
            ...
            this.store((Properties)config.getData(), this.getPath(fileName));
        }
    }
